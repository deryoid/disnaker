        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Ubah Masyarakat</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                ...
                                <div class="card card-success">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nama Masyarakat</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="nama_masyarakat" value="<?= $row['nama_masyarakat']; ?>" readonly>
                                            </div>
                                        </div>
