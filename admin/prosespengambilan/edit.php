                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-success">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            <b>
                                                ...
                                                Tanggal Pembuatan : <?= $row['tgl_buat']?><br>
                                                Tanggal Pengambilan : <?= $row['tgl_ambil']?><br>
                                                </td>    
                                                <td>Status : <b><?= $row['status_pendaftaran'] ?></b></td> <br>
                                            </b>
                                        </tr>
                                        </tbody>
                                        </table>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" name="tgl_pendaftaran" value="<?= $row['tgl_pendaftaran'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                    ...
                                    <div class="card-footer" style="background-color: white;">
                                        <a href="<?= base_url('admin/prosespengambilan/') ?>" class="btn bg-gradient-secondary float-right"><i class="fa fa-arrow-left"> Batal</i></a>
