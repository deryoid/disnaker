  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h2 style="color:green; font-family: system-ui;"><b>Dinas Tenaga Kerja</b><br>
        Kabupaten Tapin
        </h2>
        <h3>
          <img class="" src="<?= base_url() ?>/assets/dist/img/logo.png" style="margin-top: 20px; margin-bottom: 20px;" width="200px;" height="240px;">
