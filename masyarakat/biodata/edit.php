                        ...
                        <form class="form-horizontal" method="post" action="" enctype="multipart/form-data" id="saveformulir">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control " data-placeholder="Pilih " id="pekerjaan" name="pekerjaan" required="">
                                            <option value="Sudah Bekerja" <?php if ($data['pekerjaan'] == "Sudah Bekerja") {
                                                                                echo "selected";
                                                                            } ?>>Sudah Bekerja</option>
                                            <option value="Belum Bekerja" <?php if ($data['pekerjaan'] == "Belum Bekerja") {
                                                                                echo "selected";
